...
<%
	...
	//String nGroupPic="";//群头像（含后缀如.jpg或.png或.gif）(一个)
	...
	String replyPic = "";//回复者的头像图片名称（含后缀如.jpg或.png或.gif）
	...
	String guestPic = ""; //最近浏览的用户头像图片名称（含后缀如.jpg或.png或.gif）

	//将值传送给服务器；	
	Session chooseSession = null;
	...
	try {
		chooseSession = HibernateUtils.getSession();
		transaction = chooseSession.beginTransaction();
		...
		HibernateUtils.closeSession(chooseSession);
	}
